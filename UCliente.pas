...
type
  TfCliente = class(TForm)
    ...
    procedure ImportarCliente1Click(Sender: TObject);
  private
...
uses UUtil, UDM, UVendedor, UBairro, UCidade, UPessoa, UfrmClienteImportar;
...
procedure TfCliente.ControleFJ;
begin
...
procedure TfCliente.edtFJClick(Sender: TObject);
begin
   ControleFJ;
end;

procedure TfCliente.ImportarCliente1Click(Sender: TObject);
begin
   frmClienteImportar := TfrmClienteImportar.create(Self);
   frmClienteImportar.showModal;
   frmClienteImportar.free;

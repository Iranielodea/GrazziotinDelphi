...
begin
   ...
   begin
      Mensagem('Informe o Número de Série');
      Descricao.SetFocus;
      exit;
   end;
   if Codmarca.Text = '' then
   ...
   begin
      ...
      begin
         ...
         begin
            ...
            begin
               mensagem('Extintor já cadastrado');
               dm.Qsql.Close;
               exit;
            end;
            dm.Qsql.Close;
...
var
  obj: TCapacidade;
begin
  if (Capacidade.Modified) then
  begin
    obj := TCapacidade.Create;
    try
      obj.LocalizarPorMarca(StrToIntDef(CodMarca.Text, 0), Capacidade.Text);
    ...
    Capacidade.Modified := False;
  end;


//   if (Capacidade.Modified) then
//   begin
//      procura(dm.Capacidade,Capacidade.Text+'%');

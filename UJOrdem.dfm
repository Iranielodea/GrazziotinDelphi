object fjOrdem: TfjOrdem
  Left = 102
  Top = 133
  BorderStyle = bsDialog
  Caption = 'Pesquisa Ordens de Servi'#231'o'
  ClientHeight = 338
  ClientWidth = 604
  Color = clBtnFace
  ...
  object dtpesq: TSQLDataSet
    ...
    CommandText = 
      'select '#13#10'O.CODPESSOA, '#13#10'P.NOME,'#13#10'O.DATAORDEM, '#13#10'O.NUMORDEM '#13#10' fr' +
      'om TORDEM O, TPESSOA P'#13#10' where O.CODPESSOA = P.CODPESSOA'
    Params = <>
    Left = 136
    Top = 96
  end
  ...
  object Pesq: TClientDataSet
    ...
    object PesqDATAORDEM: TSQLTimeStampField
      DisplayLabel = 'Data'
      FieldName = 'DATAORDEM'
    end

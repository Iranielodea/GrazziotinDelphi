...
procedure TfParametros.FormActivate(Sender: TObject);
begin
   if sheetLista.Showing then
      Grade.SetFocus;
end;

procedure TfParametros.butCancelarClick(Sender: TObject);
begin
...
procedure TfParametros.butOkClick(Sender: TObject);
var tm: string[1];
begin
   dm.IniTrans;
   tm:='A';
...
procedure TfParametros.GradeDblClick(Sender: TObject);
begin
...
procedure TfParametros.GradeKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TfParametros.butIncClick(Sender: TObject);
begin
   sheetLista.TabVisible:=false;
   sheetCad.TabVisible:=true;
   dsCad.DataSet.Append;
...
procedure TfParametros.butExcClick(Sender: TObject);
begin
   if dsCad.DataSet.IsEmpty then
      exit;
...
procedure TfParametros.ButFecharClick(Sender: TObject);
begin
   close;
end;

procedure TfParametros.butPesqClick(Sender: TObject);
begin
...
procedure TfParametros.GradeEnter(Sender: TObject);
begin
   Self.KeyPreview:=false;
end;

procedure TfParametros.GradeExit(Sender: TObject);
begin
   Self.KeyPreview:=true;
end;

procedure TfParametros.butAltClick(Sender: TObject);
begin
   if dsCad.DataSet.IsEmpty then
      exit;
   dsCad.DataSet.Edit;
...
procedure TfParametros.butConfClick(Sender: TObject);
begin

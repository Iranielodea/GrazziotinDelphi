...
begin
   ...
   begin
      ...
      lbldata01.caption:='Período de '+dataini.Text+' até '+datafin.Text;
      RelOrdem1.print;
      ordem.close;
      free;
   end;
...
begin
   ...
   begin
      ...
      lblData1.Caption:='Perído de: '+DataIni.Text+' Até: '+DataFin.Text;
...
begin
   ...
   begin
      mensagem('Informe o Intervalo dos Níveis');
      result:=false;
   end;
